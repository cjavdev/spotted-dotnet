...
public sealed record class EpisodeObject : JsonModel
{
    ...
    public required ApiEnum<string, ReleaseDatePrecision> ReleaseDatePrecision
    {
        get
        {
            return JsonModel.GetNotNullClass<ApiEnum<string, ReleaseDatePrecision>>(
                this.RawData,
    ...
    {
        get { return JsonModel.GetNotNullClass<ShowBase>(this.RawData, "show"); }
        init { JsonModel.Set(this._rawData, "show", value); }
    }
