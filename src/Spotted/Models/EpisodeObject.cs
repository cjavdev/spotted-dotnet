...
[JsonConverter(typeof(ModelConverter<EpisodeObject, EpisodeObjectFromRaw>))]
public sealed record class EpisodeObject : ModelBase
{
    /// <summary>
    ...
    public required ApiEnum<string, ReleaseDatePrecision> ReleaseDatePrecision
    {
        get
        {
            return ModelBase.GetNotNullClass<ApiEnum<string, ReleaseDatePrecision>>(
                this.RawData,
    ...
    {
        get { return ModelBase.GetNotNullClass<ShowBase>(this.RawData, "show"); }
        init { ModelBase.Set(this._rawData, "show", value); }
    }
...
class EpisodeObjectFromRaw : IFromRaw<EpisodeObject>
{
    /// <inheritdoc/>
