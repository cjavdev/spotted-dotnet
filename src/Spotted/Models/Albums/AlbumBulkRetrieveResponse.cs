...
[JsonConverter(
    typeof(JsonModelConverter<AlbumBulkRetrieveResponse, AlbumBulkRetrieveResponseFromRaw>)
)]
public sealed record class AlbumBulkRetrieveResponse : JsonModel
{
    public required IReadOnlyList<global::Spotted.Models.Albums.Album> Albums
    {
        get
        {
            return JsonModel.GetNotNullClass<List<global::Spotted.Models.Albums.Album>>(
                this.RawData,
                "albums"
            );
        }
...
class AlbumBulkRetrieveResponseFromRaw : IFromRawJson<AlbumBulkRetrieveResponse>
{
    /// <inheritdoc/>
...
public sealed record class Album : JsonModel
{
    ...
    public required ApiEnum<string, AlbumAlbumType> AlbumType
    {
        get
        {
            return JsonModel.GetNotNullClass<ApiEnum<string, AlbumAlbumType>>(
                this.RawData,
                "album_type"
            );
        }
