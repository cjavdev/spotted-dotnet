...
public sealed record class AudioFeatureBulkRetrieveResponse : JsonModel
{
    public required IReadOnlyList<AudioFeature> AudioFeatures
    {
        get
        {
            return this._rawData.GetNotNullStruct<ImmutableArray<AudioFeature>>("audio_features");
        }
        init
        {
            this._rawData.Set<ImmutableArray<AudioFeature>>(
                "audio_features",
...
public sealed record class AudioFeature : JsonModel
{
    ...
    {
        get { return this._rawData.GetNullableClass<ApiEnum<string, AudioFeatureType>>("type"); }
        init
        {
            if (value == null)
            {
