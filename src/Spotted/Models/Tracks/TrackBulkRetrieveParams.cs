...
/// </summary>
[Obsolete("deprecated")]
public record class TrackBulkRetrieveParams : ParamsBase
{
    /// <summary>
    ...
    public TrackBulkRetrieveParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public TrackBulkRetrieveParams(TrackBulkRetrieveParams trackBulkRetrieveParams)
        : base(trackBulkRetrieveParams) { }
...
#pragma warning restore CS8618
    ...
    public static TrackBulkRetrieveParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(TrackBulkRetrieveParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    {
        return new UriBuilder(options.BaseUrl.ToString().TrimEnd('/') + "/tracks")
        {
