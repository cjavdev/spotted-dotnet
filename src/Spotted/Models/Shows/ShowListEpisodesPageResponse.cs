...
[JsonConverter(
    typeof(ModelConverter<ShowListEpisodesPageResponse, ShowListEpisodesPageResponseFromRaw>)
)]
public sealed record class ShowListEpisodesPageResponse : ModelBase
{
    /// <summary>
...
class ShowListEpisodesPageResponseFromRaw : IFromRaw<ShowListEpisodesPageResponse>
{
    /// <inheritdoc/>
