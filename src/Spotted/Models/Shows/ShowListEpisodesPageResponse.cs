...
[JsonConverter(
    typeof(JsonModelConverter<ShowListEpisodesPageResponse, ShowListEpisodesPageResponseFromRaw>)
)]
public sealed record class ShowListEpisodesPageResponse : JsonModel
{
    /// <summary>
    ...
    public ShowListEpisodesPageResponse() { }

    public ShowListEpisodesPageResponse(ShowListEpisodesPageResponse showListEpisodesPageResponse)
        : base(showListEpisodesPageResponse) { }

    public ShowListEpisodesPageResponse(IReadOnlyDictionary<string, JsonElement> rawData)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    ShowListEpisodesPageResponse(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = [.. rawData];
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="ShowListEpisodesPageResponseFromRaw.FromRawUnchecked"/>
    public static ShowListEpisodesPageResponse FromRawUnchecked(
...
class ShowListEpisodesPageResponseFromRaw : IFromRawJson<ShowListEpisodesPageResponse>
{
    /// <inheritdoc/>
    public ShowListEpisodesPageResponse FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => ShowListEpisodesPageResponse.FromRawUnchecked(rawData);
}
