...
[JsonConverter(typeof(ModelConverter<EpisodeListPageResponse, EpisodeListPageResponseFromRaw>))]
public sealed record class EpisodeListPageResponse : ModelBase
{
    /// <summary>
...
class EpisodeListPageResponseFromRaw : IFromRaw<EpisodeListPageResponse>
{
    /// <inheritdoc/>
...
public sealed record class Item : ModelBase
{
    ...
    {
        get { return ModelBase.GetNullableClass<EpisodeObject>(this.RawData, "episode"); }
        init
        {
            if (value == null)
            {
            ...
            ModelBase.Set(this._rawData, "episode", value);
        }
    }
