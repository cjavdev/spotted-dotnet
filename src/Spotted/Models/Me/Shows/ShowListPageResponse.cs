...
public sealed record class ShowListPageResponse : JsonModel
{
    ...
    {
        get { return JsonModel.GetNullableClass<List<ShowListResponse>>(this.RawData, "items"); }
        init
        {
            if (value == null)
            {
    ...
    public ShowListPageResponse() { }

    public ShowListPageResponse(ShowListPageResponse showListPageResponse)
        : base(showListPageResponse) { }
...
#pragma warning restore CS8618
    ...
    /// <inheritdoc cref="ShowListPageResponseFromRaw.FromRawUnchecked"/>
    public static ShowListPageResponse FromRawUnchecked(
