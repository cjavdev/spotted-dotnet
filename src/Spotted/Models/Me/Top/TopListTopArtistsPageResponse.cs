...
public sealed record class TopListTopArtistsPageResponse : JsonModel
{
    ...
    public TopListTopArtistsPageResponse() { }

    public TopListTopArtistsPageResponse(
        TopListTopArtistsPageResponse topListTopArtistsPageResponse
    )
        : base(topListTopArtistsPageResponse) { }

    public TopListTopArtistsPageResponse(IReadOnlyDictionary<string, JsonElement> rawData)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    TopListTopArtistsPageResponse(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = [.. rawData];
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="TopListTopArtistsPageResponseFromRaw.FromRawUnchecked"/>
    public static TopListTopArtistsPageResponse FromRawUnchecked(
...
class TopListTopArtistsPageResponseFromRaw : IFromRawJson<TopListTopArtistsPageResponse>
{
    ...
    public TopListTopArtistsPageResponse FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => TopListTopArtistsPageResponse.FromRawUnchecked(rawData);
}
