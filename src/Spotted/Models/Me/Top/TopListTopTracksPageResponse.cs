...
[JsonConverter(
    typeof(ModelConverter<TopListTopTracksPageResponse, TopListTopTracksPageResponseFromRaw>)
)]
public sealed record class TopListTopTracksPageResponse : ModelBase
{
    /// <summary>
...
class TopListTopTracksPageResponseFromRaw : IFromRaw<TopListTopTracksPageResponse>
{
    /// <inheritdoc/>
