...
/// </summary>
[Obsolete("deprecated")]
public record class AudiobookSaveParams : ParamsBase
{
    /// <summary>
    ...
    public AudiobookSaveParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public AudiobookSaveParams(AudiobookSaveParams audiobookSaveParams)
        : base(audiobookSaveParams) { }
...
#pragma warning restore CS8618
    ...
    public static AudiobookSaveParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(AudiobookSaveParams? other)
    {
        if (other == null)
        {
            return false;
