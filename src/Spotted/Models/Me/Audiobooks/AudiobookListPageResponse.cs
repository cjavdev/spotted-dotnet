...
[JsonConverter(
    typeof(JsonModelConverter<AudiobookListPageResponse, AudiobookListPageResponseFromRaw>)
)]
public sealed record class AudiobookListPageResponse : JsonModel
{
    /// <summary>
    ...
    public IReadOnlyList<AudiobookListResponse>? Items
    {
        get
        {
            return this._rawData.GetNullableStruct<ImmutableArray<AudiobookListResponse>>("items");
        }
        init
        {
            if (value == null)
            ...
            this._rawData.Set<ImmutableArray<AudiobookListResponse>?>(
                "items",
...
class AudiobookListPageResponseFromRaw : IFromRawJson<AudiobookListPageResponse>
{
    /// <inheritdoc/>
