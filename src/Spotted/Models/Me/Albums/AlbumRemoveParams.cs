...
/// </summary>
[Obsolete("deprecated")]
public record class AlbumRemoveParams : ParamsBase
{
    ...
    public AlbumRemoveParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public AlbumRemoveParams(AlbumRemoveParams albumRemoveParams)
        : base(albumRemoveParams)
    {
        this._rawBodyData = new(albumRemoveParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static AlbumRemoveParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData
    )
    ...
    public virtual bool Equals(AlbumRemoveParams? other)
    {
        if (other == null)
        {
            return false;
