...
[JsonConverter(typeof(JsonModelConverter<ChapterRetrieveResponse, ChapterRetrieveResponseFromRaw>))]
public sealed record class ChapterRetrieveResponse : JsonModel
{
    /// <summary>
    ...
    {
        get { return this._rawData.GetNotNullClass<AudiobookBase>("audiobook"); }
        init { this._rawData.Set("audiobook", value); }
    }
    ...
    {
        get { return this._rawData.GetNotNullStruct<long>("chapter_number"); }
    ...
    public required ApiEnum<
        string,
        global::Spotted.Models.Chapters.ReleaseDatePrecision
    > ReleaseDatePrecision
    {
        get
        {
            return this._rawData.GetNotNullClass<
                ApiEnum<string, global::Spotted.Models.Chapters.ReleaseDatePrecision>
    ...
    {
        get { return this._rawData.GetNullableStruct<ImmutableArray<string>>("available_markets"); }
        init
        {
            if (value == null)
            {
    ...
    {
        get { return this._rawData.GetNullableClass<ChapterRestrictionObject>("restrictions"); }
        init
        {
            if (value == null)
            {
...
#pragma warning disable CS8618
    [System::Obsolete("Required properties are deprecated: audio_preview_url")]
    [SetsRequiredMembers]
    ChapterRetrieveResponse(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="ChapterRetrieveResponseFromRaw.FromRawUnchecked"/>
    public static ChapterRetrieveResponse FromRawUnchecked(
...
class ChapterRetrieveResponseFromRaw : IFromRawJson<ChapterRetrieveResponse>
{
    /// <inheritdoc/>
    public ChapterRetrieveResponse FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => ChapterRetrieveResponse.FromRawUnchecked(rawData);
}

/// <summary>
/// The precision with which `release_date` value is known.
/// </summary>
[JsonConverter(typeof(global::Spotted.Models.Chapters.ReleaseDatePrecisionConverter))]
...
sealed class ReleaseDatePrecisionConverter
    : JsonConverter<global::Spotted.Models.Chapters.ReleaseDatePrecision>
{
    public override global::Spotted.Models.Chapters.ReleaseDatePrecision Read(
    ...
    )
    {
        ...
        {
            "year" => global::Spotted.Models.Chapters.ReleaseDatePrecision.Year,
            "month" => global::Spotted.Models.Chapters.ReleaseDatePrecision.Month,
            "day" => global::Spotted.Models.Chapters.ReleaseDatePrecision.Day,
            _ => (global::Spotted.Models.Chapters.ReleaseDatePrecision)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        global::Spotted.Models.Chapters.ReleaseDatePrecision value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                global::Spotted.Models.Chapters.ReleaseDatePrecision.Year => "year",
                global::Spotted.Models.Chapters.ReleaseDatePrecision.Month => "month",
                global::Spotted.Models.Chapters.ReleaseDatePrecision.Day => "day",
