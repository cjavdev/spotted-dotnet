...
[JsonConverter(
    typeof(ModelConverter<AudiobookBulkRetrieveResponse, AudiobookBulkRetrieveResponseFromRaw>)
)]
public sealed record class AudiobookBulkRetrieveResponse : ModelBase
{
    public required IReadOnlyList<Audiobook> Audiobooks
    {
        get { return ModelBase.GetNotNullClass<List<Audiobook>>(this.RawData, "audiobooks"); }
        init { ModelBase.Set(this._rawData, "audiobooks", value); }
    }
...
class AudiobookBulkRetrieveResponseFromRaw : IFromRaw<AudiobookBulkRetrieveResponse>
{
    /// <inheritdoc/>
...
public sealed record class Audiobook : ModelBase
{
    ...
    public required AudiobookIntersectionMember1Chapters Chapters
    {
        get
        {
            return ModelBase.GetNotNullClass<AudiobookIntersectionMember1Chapters>(
                this.RawData,
                "chapters"
            );
        }
...
[JsonConverter(
    typeof(ModelConverter<AudiobookIntersectionMember1, AudiobookIntersectionMember1FromRaw>)
)]
public sealed record class AudiobookIntersectionMember1 : ModelBase
{
    /// <summary>
    /// The chapters of the audiobook.
    /// </summary>
...
class AudiobookIntersectionMember1FromRaw : IFromRaw<AudiobookIntersectionMember1>
{
    /// <inheritdoc/>
...
public sealed record class AudiobookIntersectionMember1Chapters : ModelBase
{
    /// <summary>
...
class AudiobookIntersectionMember1ChaptersFromRaw : IFromRaw<AudiobookIntersectionMember1Chapters>
{
    /// <inheritdoc/>
