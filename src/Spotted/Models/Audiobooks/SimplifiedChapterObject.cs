...
[JsonConverter(typeof(ModelConverter<SimplifiedChapterObject, SimplifiedChapterObjectFromRaw>))]
public sealed record class SimplifiedChapterObject : ModelBase
{
    /// <summary>
...
class SimplifiedChapterObjectFromRaw : IFromRaw<SimplifiedChapterObject>
{
    /// <inheritdoc/>
