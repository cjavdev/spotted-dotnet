...
public sealed record class AudiobookListChaptersPageResponse : ModelBase
{
    ...
    public AudiobookListChaptersPageResponse() { }

    public AudiobookListChaptersPageResponse(
        AudiobookListChaptersPageResponse audiobookListChaptersPageResponse
    )
        : base(audiobookListChaptersPageResponse) { }

    public AudiobookListChaptersPageResponse(IReadOnlyDictionary<string, JsonElement> rawData)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    AudiobookListChaptersPageResponse(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = [.. rawData];
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="AudiobookListChaptersPageResponseFromRaw.FromRawUnchecked"/>
    public static AudiobookListChaptersPageResponse FromRawUnchecked(
...
class AudiobookListChaptersPageResponseFromRaw : IFromRaw<AudiobookListChaptersPageResponse>
{
    ...
    public AudiobookListChaptersPageResponse FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => AudiobookListChaptersPageResponse.FromRawUnchecked(rawData);
}
