...
/// </summary>
[Obsolete("deprecated")]
public record class UserRetrieveProfileParams : ParamsBase
{
...
#pragma warning restore CS8618
    ...
    public static UserRetrieveProfileParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string userID
    )
    ...
    public virtual bool Equals(UserRetrieveProfileParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/') + string.Format("/users/{0}", this.UserID)
        )
        {
