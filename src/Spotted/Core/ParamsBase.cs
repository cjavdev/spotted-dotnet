...
public abstract record class ParamsBase
{
    ...
    static ParamsBase()
    {
        ...
        var customHeadersEnv = Environment.GetEnvironmentVariable("SPOTTED_CUSTOM_HEADERS");
    ...
    static string GetUserAgent() => $"{typeof(SpottedClient).Name}/C# {GetPackageVersion()}";
