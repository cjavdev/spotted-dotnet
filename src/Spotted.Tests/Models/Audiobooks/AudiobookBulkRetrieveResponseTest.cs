...
public class AudiobookBulkRetrieveResponseTest : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<AudiobookBulkRetrieveResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        AudiobookBulkRetrieveResponse copied = new(model);
...
public class AudiobookIntersectionMember1Test : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<AudiobookIntersectionMember1>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        AudiobookIntersectionMember1 copied = new(model);
...
public class AudiobookIntersectionMember1ChaptersTest : TestBase
{
    ...
    public void CopyConstructor_Works()
    {
        ...
        AudiobookIntersectionMember1Chapters copied = new(model);
