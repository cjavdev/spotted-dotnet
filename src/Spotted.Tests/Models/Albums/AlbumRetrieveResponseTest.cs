...
public class AlbumRetrieveResponseTest : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<AlbumRetrieveResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        AlbumRetrieveResponse copied = new(model);
...
public class AlbumRetrieveResponseTracksTest : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<AlbumRetrieveResponseTracks>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        AlbumRetrieveResponseTracks copied = new(model);
