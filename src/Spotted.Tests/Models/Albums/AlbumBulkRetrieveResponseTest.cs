...
public class AlbumBulkRetrieveResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new AlbumBulkRetrieveResponse
        {
            Albums =
            [
                new()
                {
                    ...
                    AlbumType = AlbumAlbumType.Compilation,
        ...
        Assert.Equal(expectedAlbums.Count, model.Albums.Count);
        for (int i = 0; i < expectedAlbums.Count; i++)
        {
            Assert.Equal(expectedAlbums[i], model.Albums[i]);
        }
    }
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<AlbumBulkRetrieveResponse>(
            json,
    ...
    public void FieldRoundtripThroughSerialization_Works()
    {
        ...
        Assert.Equal(expectedAlbums.Count, deserialized.Albums.Count);
        for (int i = 0; i < expectedAlbums.Count; i++)
        {
            Assert.Equal(expectedAlbums[i], deserialized.Albums[i]);
        }
    }
    ...
    public void CopyConstructor_Works()
    {
        ...
        AlbumBulkRetrieveResponse copied = new(model);
...
public class AlbumTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        ...
        ApiEnum<string, AlbumAlbumType> expectedAlbumType = AlbumAlbumType.Compilation;
        ...
        AlbumTracks expectedTracks = new()
        {
            Href = "https://api.spotify.com/v1/me/shows?offset=0&limit=20\n",
            Limit = 20,
            Next = "https://api.spotify.com/v1/me/shows?offset=1&limit=1",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<Album>(json, ModelBase.SerializerOptions);
    ...
    public void FieldRoundtripThroughSerialization_Works()
    {
        ...
        string element = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<Album>(element, ModelBase.SerializerOptions);
        Assert.NotNull(deserialized);
...
public class AlbumTracksTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new AlbumTracks
        {
            Href = "https://api.spotify.com/v1/me/shows?offset=0&limit=20\n",
            Limit = 20,
            Next = "https://api.spotify.com/v1/me/shows?offset=1&limit=1",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<AlbumTracks>(
            json,
            ModelBase.SerializerOptions
        );
