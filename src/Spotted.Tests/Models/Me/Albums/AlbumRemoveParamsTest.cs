...
public class AlbumRemoveParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new AlbumRemoveParams { Ids = ["string"], Published = true };
    ...
    {
        var parameters = new AlbumRemoveParams { };
    ...
    {
        AlbumRemoveParams parameters = new();

        var url = parameters.Url(new() { AccessToken = "My Access Token" });

        Assert.True(TestBase.UrisEqual(new Uri("https://api.spotify.com/v1/me/albums"), url));
    }
    ...
    public void CopyConstructor_Works()
    {
        ...
        AlbumRemoveParams copied = new(parameters);
