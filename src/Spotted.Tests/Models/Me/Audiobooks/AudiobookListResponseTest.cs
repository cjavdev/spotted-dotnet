...
public class AudiobookListResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new AudiobookListResponse
        {
                ...
                Chapters = new()
                {
                    ...
                    [
                        new()
                        {
                            ...
                            ReleaseDatePrecision = Audiobooks::ReleaseDatePrecision.Day,
        ...
        Audiobook expectedAudiobook = new()
        {
            ID = "id",
            Authors = [new() { Name = "name", Published = true }],
            AvailableMarkets = ["string"],
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<AudiobookListResponse>(
            json,
    ...
    public void OptionalNonNullablePropertiesUnsetAreNotSet_Works()
    {
        ...
        Assert.Null(model.Audiobook);
        Assert.False(model.RawData.ContainsKey("audiobook"));
    ...
    public void CopyConstructor_Works()
    {
        ...
        AudiobookListResponse copied = new(model);
...
public class AudiobookTest : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<Audiobook>(json, ModelBase.SerializerOptions);
    ...
    public void FieldRoundtripThroughSerialization_Works()
    {
        ...
        string element = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<Audiobook>(
            element,
            ModelBase.SerializerOptions
        );
        Assert.NotNull(deserialized);
...
public class IntersectionMember1ChaptersTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        ...
        List<Audiobooks::SimplifiedChapterObject> expectedItems =
        [
            new()
            {
                ID = "5Xt5DXGzch68nYYamXrNxZ",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<IntersectionMember1Chapters>(
            json,
            ModelBase.SerializerOptions
        );
