...
public class ShowRemoveParamsTest : TestBase
{
    [Fact]
    ...
    {
        var parameters = new ShowRemoveParams { };
    ...
    {
        ShowRemoveParams parameters = new();

        var url = parameters.Url(new() { AccessToken = "My Access Token" });

        Assert.True(TestBase.UrisEqual(new Uri("https://api.spotify.com/v1/me/shows"), url));
    }
