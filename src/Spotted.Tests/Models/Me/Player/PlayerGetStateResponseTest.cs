...
public class PlayerGetStateResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new PlayerGetStateResponse
        {
            Actions = new()
            {
        ...
        DeviceObject expectedDevice = new()
        {
            ID = "id",
            IsActive = true,
            IsPrivateSession = true,
        ...
        PlayerGetStateResponseItem expectedItem = new TrackObject()
        {
            ID = "id",
            Album = new()
            {
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<PlayerGetStateResponse>(
            json,
    ...
    public void OptionalNonNullablePropertiesUnsetAreNotSet_Works()
    {
        ...
        Assert.False(model.RawData.ContainsKey("shuffle_state"));
    ...
    public void CopyConstructor_Works()
    {
        ...
        PlayerGetStateResponse copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class PlayerGetStateResponseActionsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new PlayerGetStateResponseActions
        {
            InterruptingPlayback = true,
            Pausing = true,
            Published = true,
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<PlayerGetStateResponseActions>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        PlayerGetStateResponseActions copied = new(model);
...
public class PlayerGetStateResponseItemTest : TestBase
{
    ...
    {
        PlayerGetStateResponseItem value = new TrackObject()
        {
            ID = "id",
            Album = new()
            {
    ...
    {
        PlayerGetStateResponseItem value = new EpisodeObject()
        {
    ...
    public void TrackObjectSerializationRoundtripWorks()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<PlayerGetStateResponseItem>(
            element,
            ModelBase.SerializerOptions
        );
