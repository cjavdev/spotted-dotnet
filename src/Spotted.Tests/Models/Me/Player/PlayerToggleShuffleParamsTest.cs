...
public class PlayerToggleShuffleParamsTest : TestBase
{
    ...
    {
        PlayerToggleShuffleParams parameters = new()
        {
            State = true,
            DeviceID = "0d1841b0976bae2a3a310dd74c0f3df354899bc8",
        };
        ...
        Assert.True(
            TestBase.UrisEqual(
                new Uri(
                    "https://api.spotify.com/v1/me/player/shuffle?state=true&device_id=0d1841b0976bae2a3a310dd74c0f3df354899bc8"
                ),
                url
            )
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        PlayerToggleShuffleParams copied = new(parameters);
