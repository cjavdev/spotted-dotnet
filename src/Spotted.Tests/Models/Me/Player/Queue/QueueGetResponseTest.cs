...
public class QueueGetResponseTest : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<QueueGetResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        QueueGetResponse copied = new(model);
...
public class CurrentlyPlayingTest : TestBase
{
    ...
    {
        CurrentlyPlaying value = new TrackObject()
        {
            ID = "id",
            Album = new()
            {
    ...
    {
        CurrentlyPlaying value = new EpisodeObject()
        {
    ...
    public void TrackObjectSerializationRoundtripWorks()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<CurrentlyPlaying>(
            element,
            ModelBase.SerializerOptions
        );
...
public class QueueGetResponseQueueTest : TestBase
{
    ...
    public void TrackObjectValidationWorks()
    {
        QueueGetResponseQueue value = new TrackObject()
        {
            ID = "id",
            Album = new()
            {
    ...
    public void EpisodeObjectValidationWorks()
    {
        QueueGetResponseQueue value = new EpisodeObject()
        {
            ID = "5Xt5DXGzch68nYYamXrNxZ",
            AudioPreviewUrl =
                "https://p.scdn.co/mp3-preview/2f37da1d4221f40b9d1a98cd191f4d6f1646ad17",
    ...
    public void TrackObjectSerializationRoundtripWorks()
    {
        ...
        string element = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<QueueGetResponseQueue>(
            element,
            ModelBase.SerializerOptions
        );
