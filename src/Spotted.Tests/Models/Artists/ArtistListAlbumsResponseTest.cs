...
public class ArtistListAlbumsResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        ...
        ApiEnum<string, AlbumGroup> expectedAlbumGroup = AlbumGroup.Compilation;
        ...
        Assert.Equal(expectedAlbumGroup, model.AlbumGroup);
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<ArtistListAlbumsResponse>(json);
    ...
    public void FieldRoundtripThroughSerialization_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<ArtistListAlbumsResponse>(element);
        ...
        Assert.Equal(expectedAlbumGroup, deserialized.AlbumGroup);
...
{
    [Theory]
    [InlineData(AlbumGroup.Album)]
    [InlineData(AlbumGroup.Single)]
    [InlineData(AlbumGroup.Compilation)]
    [InlineData(AlbumGroup.AppearsOn)]
    public void Validation_Works(AlbumGroup rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, AlbumGroup> value = rawValue;
        value.Validate();
    }
    ...
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, AlbumGroup>>(
    ...
    [InlineData(AlbumGroup.Compilation)]
    [InlineData(AlbumGroup.AppearsOn)]
    public void SerializationRoundtrip_Works(AlbumGroup rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, AlbumGroup> value = rawValue;

        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ApiEnum<string, AlbumGroup>>(
            json,
            ModelBase.SerializerOptions
        );
