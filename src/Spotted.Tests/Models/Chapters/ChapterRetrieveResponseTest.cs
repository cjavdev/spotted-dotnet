...
public class ChapterRetrieveResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ChapterRetrieveResponse
        {
        ...
        string expectedAudioPreviewURL =
            "https://p.scdn.co/mp3-preview/2f37da1d4221f40b9d1a98cd191f4d6f1646ad17";
        Models::AudiobookBase expectedAudiobook = new()
        {
            ID = "id",
            Authors = [new() { Name = "name", Published = true }],
            AvailableMarkets = ["string"],
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<ChapterRetrieveResponse>(json);
    ...
    public void FieldRoundtripThroughSerialization_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<ChapterRetrieveResponse>(element);
