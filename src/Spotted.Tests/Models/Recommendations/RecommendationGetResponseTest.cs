...
public class RecommendationGetResponseTest : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<RecommendationGetResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        RecommendationGetResponse copied = new(model);
...
public class SeedTest : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<Seed>(json, ModelBase.SerializerOptions);
    ...
    public void FieldRoundtripThroughSerialization_Works()
    {
        ...
        string element = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<Seed>(element, ModelBase.SerializerOptions);
        Assert.NotNull(deserialized);
