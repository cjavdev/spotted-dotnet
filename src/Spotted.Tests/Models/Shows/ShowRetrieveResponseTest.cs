...
public class ShowRetrieveResponseTest : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<ShowRetrieveResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        ShowRetrieveResponse copied = new(model);
...
public class IntersectionMember1EpisodesTest : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<IntersectionMember1Episodes>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        IntersectionMember1Episodes copied = new(model);
