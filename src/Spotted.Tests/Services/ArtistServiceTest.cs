...
public class ArtistServiceTest : TestBase
{
    ...
    {
        var artistObject = await this.client.Artists.Retrieve("0TnOYISbd1XYRBk9myaseg");
    ...
    {
        var page = await this.client.Artists.ListAlbums("0TnOYISbd1XYRBk9myaseg");
        page.Validate();
    }
    ...
    {
        var response = await this.client.Artists.ListRelatedArtists("0TnOYISbd1XYRBk9myaseg");
        response.Validate();
    }
    ...
    {
        var response = await this.client.Artists.TopTracks("0TnOYISbd1XYRBk9myaseg");
        response.Validate();
    }
}
